...
from dc_ldm.modules.diffusionmodules.openaimodel import UNetModel, TimestepEmbedSequential, ResBlock, Downsample, AttentionBlock
from dc_ldm.models.diffusion.ddpm import LatentDiffusion
from dc_ldm.util import instantiate_from_config, log_txt_as_img, exists
...
class ControlNet(nn.Module):
    ...
    def forward(self, x, hint, timesteps, context, **kwargs):
        ...
        hint = self.control_stage_model(hint)
